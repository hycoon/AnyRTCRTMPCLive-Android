...
import org.anyrtc.constant.constant;
...
//        RTMPCHybird.Inst().DisableHWDecode();
        RTMPCHybird.Inst().InitEngineWithAnyrtcInfo(constant.DEVELOP_ID, constant.APP_ID, constant.APP_KEY,constant.APP_TOKEN);
//        RTMPCHybird.Inst().ConfigServerForPriCloud("192.168.7.207", 9060);

        {
             ...
             * 获取直播列表
             */
            RTMPCHttpSDK.GetLiveList(this, RTMPCHybird.Inst().GetHttpAddr(), constant.DEVELOP_ID, constant.APP_ID,
                    constant.APP_TOKEN, mRTMPCHttpCallback);
        }
